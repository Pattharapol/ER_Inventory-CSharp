...
namespace ER_Inventory_v._1
{
    public partial class frmCategoryList : Form
    {
        ...
        // load Category -- START
        public void loadRecordCategory()
        {
            ...
            dr.Close();
            cn.Close();
            lblCount.Text = "มีข้อมูลทั้งหมด " + dgvCategory.RowCount + " รายการ";
        ...
        private void DgvCategory_SelectionChanged(object sender, EventArgs e)
        {
            ...
            _id = dgvCategory.Rows[i].Cells[1].Value.ToString();
            _category = dgvCategory.Rows[i].Cells[2].Value.ToString();
