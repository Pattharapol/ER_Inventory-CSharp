...
namespace ER_Inventory_v._1
{
    public partial class frmStockIn : Form
    {
        ...
        private void dgv2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    frmQTY.ShowDialog();
            //    frmQTY.txtQTY.Focus();
            //    frmQTY.lblID.Text = dgv2.CurrentRow.Cells[9].Value.ToString();
            //}
            //txtSearch.Clear();
            //txtSearch.Focus();
        }// remove row -- END
        ...
        private void loadStockInHistory()
        {
            try
            {
                ...
                cm.ExecuteNonQuery();
                cn.Close();
                lblCount.Text = "ข้อมูลทั้งหมด " + dgvStockInHistory.RowCount + " รายการ";
            }
            catch
            {
        ...
        private void BtnSave_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                frmStockInReport frmStockInReport = new frmStockInReport();
